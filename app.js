(() => {
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full Grantor record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · Grantor Chrome evidence run</small></div>
